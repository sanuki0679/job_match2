<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Company Profile -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="company_profile" value="{{ ('会社紹介') }}" />
            <textarea name="company_profile" id="company_profile" cols="30" rows="5" class="border-gray-300 forcus:border--indigo-300 forcus:ring forcus:ring-indigo-200 forcus:ring-opacity-50 rounded-md shadow-sm block mt-1 w-full" wire:model.defer="state.company.profile" ></textarea>

    ...
    <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen max-w-7xl mx-auto">
        <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
            @can('user')
                <div class="relative">
                    {{-- オンライン状態の表示(未実装) --}}
                    <span class="adsolute text-green-500 right-0 bottom-0">
                ...
                <div class="chat-message">
                    <div class="flex items-end justify-end">
                        ...
                        <button class="delete-button" id="{{ $message->id }}" type="button">
                            ...
                            <svg class="w-6 h-6 text-gray-600 pointer-events-none" fill="none" stroke="currentColor"
    ...
    <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0 sticky bottom-2">
        <div class="relative flex">
            ...
            <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
                {{-- リンクボタン(未実装) --}}
                <button type="button"
                    class="inlline-flex items-center justify-center rounded-full h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        class="h-6 w-6 text-gray-600">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                {{-- 絵文字ボタン(未実装) --}}
                <button type="button"
                    class="inline-flex items-center justify-center rounded-full h-10 w-10 transition duration-500 ease-in-oout text-gray-500 hover:bg-grsy-300 focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        class="h-6 w-6 text-gray-600">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
